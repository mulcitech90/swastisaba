        ...
        <div class="card">
            ...
            <div class="card-header">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bold text-gray-900">Master Kelembagaan</span>
                    <span class="text-muted mt-1 fw-semibold fs-7">Data Master Kelembagaan</span>
                </h3>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="tambahModalLabel">Tambah Data Kelembagaan</h5>
            ...
            <div class="modal-body">
                ...
                <form id="formTambah">
                    ...
                    <div class="mb-3">
                        <label for="namaDinas" class="form-label">Nama Kelembagaan</label>
                        <input type="text" class="form-control" id="namaDinas" name="namaDinas" placeholder="Masukkan nama Kelembgaan">
                    </div>
                </form>
            </div>
...
<script>
    ...
    function submitTambah() {
        ...
        $.ajax({
            url: '{{ route("master.kelembagaan.store") }}', // Ganti URL dengan route yang sesuai
            method: 'POST',
            data: {
                _token: '{{ csrf_token() }}',
                nama: namaDinas
   ...
   function editData(id) {
        ...
        $.get("kelembagaan/" + id + "/edit", function(response) { // Ganti URL dengan URL yang sesuai
            ...
            swal({
                ...
                content: {
                    element: "input",
                    attributes: {
                        value: response.nama_kelembagaan,
